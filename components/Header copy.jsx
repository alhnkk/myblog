    ...
    <div className="relative z-10 bg-yellow-300 dark:bg-gray-400 shadow-md">
        ...
        <div className="relative flex items-center justify-between h-16">
            ...
            <div className="hidden flex-1 lg:flex justify-end px-2 lg:ml-6">
                <div className="flex">
                <Link href={"/"} > 
                    <a className='ml-4 px-3 py-2 rounded-lg text-gray-700 font-semibold hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 '>AnaSayfa</a>
                    
                </Link>

                <Link href={"/contact"}>
                    <a className='ml-4 px-3 py-2 rounded-lg text-gray-700 font-semibold hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 '>İletişim</a>
                </Link>

                <Link href={"/about"}>
                    <a className='ml-4 px-3 py-2 rounded-lg text-gray-700 font-semibold hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 '>Hakkımda</a>
                </Link>
                ...
                <form class="flex items-center">   
                    <div class="relative w-full">
                        ...
                        <input type="text" id="simple-search" class="bg-gray-50 border border-gray-100 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Şu an aktif değil" required=""/>
                    </div>
                </form>
