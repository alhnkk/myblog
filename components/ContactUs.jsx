...
<div className="lg:flex lg:flex-col h-screen bg-center bg-cover bg-no-repeat">
            ...
            <h1 className="text-center text-5xl font-semibold text-blue-500">Sosyal Medya Hesaplarım</h1>
